...
function getDataFromBowlingTables(newHtmlString) {
    ...
    // why everytime output change becoz of request async function
...
function extractBirthdays(body) {
    ...
    let spanArr =   document.querySelectorAll(".ds-text-title-s.ds-font-bold.ds-text-ui-typo");
    let birthday =spanArr[1].textContent;
    let name = spanArr[0].textContent;
...
//why every page have same html structure
